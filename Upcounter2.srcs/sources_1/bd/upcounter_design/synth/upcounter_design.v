...
module upcounter_design
  ...
  wire [7:0]FND_counter_0_o_fnd_font;
  wire [3:0]FND_counter_0_o_fnd_select;
  wire i_clk_0_1;
  wire i_reset_0_1;
  ...
  assign o_fnd_font[7:0] = FND_counter_0_o_fnd_font;
  assign o_fnd_select[3:0] = FND_counter_0_o_fnd_select;
  upcounter_design_FND_counter_0_0 FND_counter_0
       (.i_clk(i_clk_0_1),
        .i_reset(i_reset_0_1),
        .i_value(i_value_0_1),
        .o_fnd_font(FND_counter_0_o_fnd_font),
        .o_fnd_select(FND_counter_0_o_fnd_select));
endmodule
